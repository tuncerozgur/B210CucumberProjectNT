...
@CucumberOptions(//bu notasyon sayesinde hangi scenariolari calistiracagimiz ve hangi raporlari alacağımızı belirtiriz
        ...
        plugin = {
                ...
                "rerun:TestOutput/failed_scenario.txt"//rerun pluguni ile fail olan scenariolari burada belirtmis oldugumuz txt dosyasi icinde tutabiliriz
        },
...
Sadece fail olan scenariolarimizi calistiracagi icin bu class'ta tags parametresine ihtiyac yoktur

iliskilendirdigimiz dosya failed_scenario.txt icine fail olan  testler depolanir ,
eger test gecerse fail olan test bu dosyadan kaybolur
gecmesse orada arşivli bir şekilde kalmaya devam eder ve kalan testlerimizi burada görüntüleyebiliriz.
calisma kolaylıgı saglar
